...
_e(function (E, $) {
    ...
    E.fn.updateValue = function () {
        ...
        var value = $txt.html();
        if($txt.text()=='' && $txt.find('img').length==0){
            value = '';
        }
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        */
        ...
        // 创建droplist
        var tpl = '<span style="font-size:{#commandvalue}px;">{#title}</span>';
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
        ...
        function afterEvent(e) {
            ...
            if(rangeElem){
                ...
                rangeElem = $("font[size]",rangeElem);
            }
            var size = $(this.currentTarget).attr('commandValue')
            rangeElem.removeAttr("size").css("font-size",size+"px");   
        }
        // 增加到editor对象中
        editor.menus[menuId] = menu;
    });
